 ...
 *            a 如有截取用来补足，默认为'...'
 * @param {Bool}
 *            b 是否按字节截取，true 按字符 false(默认) 按字节
...
<div class="woo"><div class="j"> \
	<div class="mbpho" style="height:<%=u.iht > 800 ? 800 : u.iht%>px;"><a target="_blank" class="a" href="http://localhost:8080/assets/SZU/SZU0001.jpg"><img <%=srcd ? "srcd" : "src"%>="<%=u.isrc%>" height="<%=u.iht%>" /><%= u.iht > 800 ? "<u style=\'margin-top:-"+(u.iht-720)+"px\'></u>" : ""%></a> \
	</div> \
		...
		function (h){
			...
			if(jsn.success){
				...
				for(var i=0,d=dat.albums,l=d.length; i<l; i++){
					var unt = [
							'<div class="woo"  data-ht="328"> <div class="albbigimg"> <p class="lev2"></p> <p class="lev1"></p> <a class="lev0" href="http://www.duitang.com/topics/" target="_blank" ><img src="http://localhost:8080/assets/SZU/SZU0001.jpg" alt="动漫集 ."></a> <p class="lev3"></p> <div>动漫集 .</div> </div> <ul> <li><span>3736个收集 | 103人喜欢</span></li> <li class="clr"><a href="http://www.duitang.com/topics/" target="_blank" ><img src="http://localhost:8080/assets/SZU/SZU0001.jpg" />笑我作茧自缚还…</a></li> <li>有壁纸.</li> </ul> </div>'
						].join('')
